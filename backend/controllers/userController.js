...
const getProfile = async (req, res) => {
    ...
    try {
        ...
        const userData = await userModel.findById(userId).select('-password') // without the password
...
const updateProfile = async (req, res) => { // form req
...
const bookAppointment = async (req, res) => {
    ...
    try {
        ...
        const { userId, physiotherapistId, slotDate, slotTime } = req.body // userId este initializat din jwb din middleware !
        ...
        delete physiotherapistData.slots_booked
        ...
        const appointmentData = {
            ...
            userData,
            physiotherapistData,
            amount: physiotherapistData.fees,
            slotTime,
            slotDate,
            date: Date.now()
        }
...
const cancelAppointment = async (req, res) => {
    try {
        ...
        // releasing physiotherapist slot 
        const { physiotherapistId, slotDate, slotTime } = appointmentData
