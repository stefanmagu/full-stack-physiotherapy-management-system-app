...
const PhysiotherapistAppointments = () => {
  ...
  const { dToken, appointments, getAppointments, cancelAppointment, completeAppointment } = useContext(PhysiotherapistContext)
...
export default PhysiotherapistAppointments 